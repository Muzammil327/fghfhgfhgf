...
const data = {
  ...
  description:
    "download class 12 free study material of all books, notes, past paper and all board punjab sindh etc. available here.",
  canonical: "/study-material/12th/",
  index: true,
  follow: true,
  image: "/opengraph-image.jpg",
  url: "https://growlearnhub.com/study-material/12th/",
  keywords: [
    "growlearnhub 12th class study material",
...
const datas: CardProps[] = [{ id: 0, title: "Books", link: "/12th/books/" }];
