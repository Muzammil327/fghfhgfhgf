...
const data = {
  ...
  canonical: "/class/class-9/punjab-board-biology/urdu/",
  index: true,
  follow: true,
  image:
    "/9th/book/biology/Download-Punjab-Board-Biology-Book-urdu-medium.webp",
  url: "https://growlearnhub.com/class/class-9/punjab-board-biology/urdu/",
  keywords: ["cs201", "Introducing to Programming", "vu cs201"],
  fileName: "class-9-punjab-board-biology-book-urdu-medium.pdf",
  fileId: "/9th/book/biology/class-9-punjab-board-biology-book-urdu-medium.pdf",
};
