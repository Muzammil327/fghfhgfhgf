...
import { VU_BookDatas } from "../../data";
import Form from "@/src/components/element/form/page";
import { Metadata } from "next";
import { class_Book, vu_Book } from "@/src/app/(books)/type";
      ...
      <Container>
        <div className="grid lg:grid-cols-11 gap-2 mb-12">
          <div className="col-span-8">
            <div className="grid gap-4 md:grid-cols-2 grid-cols-1 my-2">
              {VU_BookDatas.map((data: vu_Book) => {
                return (
