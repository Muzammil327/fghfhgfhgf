      ...
      <Container>
        <div className="grid lg:grid-cols-11 gap-2 mb-12">
          <div className="col-span-8">
            ...
            <h2 className="text-xl font-semibold py-2">Punjab Board Class 12 Books</h2>
...
const punjabBook = [
  { id: 0, title: "Physics Books", link: "/12th/books/" },
  { id: 1, title: "Biology Books", link: "/12th/books/" },
];
